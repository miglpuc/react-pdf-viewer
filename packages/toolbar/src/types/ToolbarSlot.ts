...
import { type EnterFullScreenMenuItemProps, type EnterFullScreenProps } from '@react-pdf-viewer-fork/full-screen';
import { type DownloadMenuItemProps, type DownloadProps } from '@react-pdf-viewer-fork/get-file';
import { type OpenProps } from '@react-pdf-viewer-fork/open';
import {
...
import { type PrintMenuItemProps, type PrintProps } from '@react-pdf-viewer-fork/print';
import { type ShowPropertiesMenuItemProps, type ShowPropertiesProps } from '@react-pdf-viewer-fork/properties';
import { type RotateDecoratorProps, type RotateProps } from '@react-pdf-viewer-fork/rotate';
import {
    type SwitchScrollModeMenuItemProps,
    type SwitchScrollModeProps,
    type SwitchViewModeMenuItemProps,
    type SwitchViewModeProps,
} from '@react-pdf-viewer-fork/scroll-mode';
import { type SearchProps, type ShowSearchPopoverProps } from '@react-pdf-viewer-fork/search';
import { type SwitchSelectionModeMenuItemProps, type SwitchSelectionModeProps } from '@react-pdf-viewer-fork/selection-mode';
import { type SwitchThemeMenuItemProps, type SwitchThemeProps } from '@react-pdf-viewer-fork/theme';
import {
    ...
    type ZoomOutProps,
    type ZoomProps,
} from '@react-pdf-viewer-fork/zoom';
